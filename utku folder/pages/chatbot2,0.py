...
def load_models():
    ...
    model_path = ROOT / "data" / "models" / "season_models.pkl"
...
def load_all_data():
    ...
    hourly_df  = pd.read_csv(os.path.join(DATA, "hourly_location_avg.csv"))
    monthly_df = pd.read_csv(os.path.join(DATA, "monthly_location_avg.csv"))
    rf_preds   = pd.read_csv(os.path.join(DATA, "hourly_rf_predictions.csv"))
    df2 = pd.read_csv(os.path.join(DATA, "ALL_BOROUGHS_SARIMA_72H.csv"))
